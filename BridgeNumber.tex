...
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}[
        verti/.style={black!50,fill,inner sep=0pt,minimum width=1.6pt,minimum height=2mm},
        horiz/.style={black!50,fill,inner sep=0pt,minimum width=2mm,minimum height=1.6pt}
    ]
        \begin{knot}[
            clip width=5,
            consider self intersections,
    ...
    \end{tikzpicture}
    \vspace{-0.8em}
    \caption{A projection of the trefoil knot displaying $b(K)=2$.}
    \label{fig:trefoilfin}
\end{figure}

Because $b(K)=2$ for the trefoil knot, Figure \ref{fig:trefoilclrb} is the minimal-bridge projection. This projection is cleaned up in Figure \ref{fig:trefoilfin}.
...
\begin{figure}[h!]
    ...
    \end{tikzpicture}
    \vspace{-1.5em}
    \caption{The knot, $8_{10}$, being labeled in Dowker notation.}
    \label{fig:810Dowker}
\end{figure}
...
\begin{table}[h!]
    ...
    \begin{tabular}{cccccccc}
        ...
        1  & 2  & 3  & 4 & 5  & 6  & 7  & 8
    \end{tabular}
    \caption{Dowker pairs for the knot, $8_{10}$.}
    \label{tab:810Dowker}
\end{table}

While $8_{10}$ appears scary at first, its superior killzone is actually ideal. Start assigning a Dowker labeling at the \textcolor{green}{light green} crossing and continue along the orientation given in Figure \ref{fig:810Dowker}. This will generate the labeling shown in Table \ref{tab:810Dowker}.\par
...
\begin{figure}[h!]
    ...
    \end{tikzpicture}
    \vspace{-0.8em}
    \caption{A reconstruction of the knot, $8_{10}$.}
    \label{fig:810recon}
\end{figure}

Reconstruct a knot projection from the pairings in Table \ref{tab:810Dowker} to yield Figure \ref{fig:810recon}$^[$\footnote{The alert reader will notice that the crossings are flipped from what they should be in a Dowker reconstruction based on Figure \ref{fig:810Dowker}. I made this error in my draft and have not changed it here both because of time considerations and because the example, as it stands, still highlights all of my key points.}$^]$. In this projection, there are four appealing opportunities for Type I bridging moves. However, since the middle two share a common strand, there are actually only three.\par
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[
        ...
        \begin{knot}[
            ...
            \strand [red,thick] (0.5,0) to (3.5,0);
            \strand [blue,thick] (3.5,0) to (4.5,0);
            \strand [red,thick] (4.5,0)
                to (8.5,0)
                to [out=0,in=-90] (9,0.5)
                to (9,\h)
                to [out=90,in=90,looseness=0.5] (4,\h)
            ;
            \strand [grx,thick] (4,\h)
                to [out=-90,in=90] (5,0)
            ;
            \strand [red,thick] (5,0)
                to (5,-\h)
                to [out=-90,in=-90] (4,-\h)
                to (4,0)
                to [out=90,in=-90] (5,\h)
                ...
                to [out=90,in=180] (0.5,0)
            ;
            \flipcrossings{3,4,9,10,11,14,15,19,20}
        \end{knot}
        \node [verti] at (0.5,0) {};
        \node [horiz] at (9,\h) {};
        \foreach \x in {1,...,8} {
        ...
        \draw [orange,very thick,dashed] (6,0) circle (5mm);
    \end{tikzpicture}
    \vspace{-0.8em}
    \caption{Combining bridges in the knot, $8_{10}$.}
    \label{fig:810clr}
\end{figure}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[
        ...
        \begin{knot}[
            ...
            \strand [red,thick] (0.5,0) to (3.5,0);
            \strand [blue,thick] (3.5,0)
                to [out=0,in=-135] (4,{0.5*\h})
                to [out=45,in=-90] (4.67,\h)
                to [out=90,in=90] (6.33,\h)
                to (6.33,0)
                to [out=-90,in=-90,looseness=1.8] (5.67,0)
                to [out=90,in=180,out looseness=2] (4.5,0)
            ;
            \strand [red,thick] (4.5,0) to (7.5,0);
            \strand [pux,thick] (7.5,0) to (8.5,0);
            \strand [red,thick] (8.5,0)
                to [out=0,in=-90] (9,0.5)
                to (9,\h)
                to [out=90,in=90] (4,\h)
            ;
            \strand [grx,thick] (4,\h)
                to [out=-90,in=-90,looseness=2] (4.33,\h)
                to [out=90,in=90] (6.67,\h)
                to (6.67,0)
                to [out=-90,in=-90,looseness=1.8] (5.33,0)
                to [out=90,in=90, looseness=2] (5,0)
            ;
            \strand [red,thick] (5,0)
                to (5,-\h)
                to [out=-90,in=-90] (4,-\h)
                ...
                to (7,0)
            ;
            \strand [max,thick] (7,0)
                to [out=-90,in=90] (8,-\h)
            ;
            \strand [red,thick] (8,-\h)
                to [out=-90,in=-90] (10,-\h)
                to (10,\h)
                to [out=90,in=90] (3,\h)
                to (3,-\h)
                ...
                to [out=90,in=180] (0.5,0)
            ;
            \flipcrossings{4,5,14,15,19,20,22,29,30}
            \redraw{6}{(5.33,0)}
            \redraw{3}{(5,0)}
            \redraw{6}{(5,0)}
            \redraw{7}{(5,0)}
        ...
        \fill [white] (5.05,-0.03) rectangle (5.2,-0.2);
    \end{tikzpicture}
    \vspace{-0.8em}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \end{knot}
    \end{tikzpicture}
    \caption{A set of two bridging moves.}
    \label{fig:set}
\end{figure}

\begin{defi}
    \begin{description}
        \item[Set \textnormal{(of bridging moves)}] \hfill \\ Where $n\geq 2$, $n$ Type II bridging moves that reduce the number of bridges by shifting $n$ adjacent overpasses to the opposite side of the same crossing.
    \end{description}
\end{defi}
    ...
    \begin{tikzpicture}[
        ...
        \begin{knot}[
            ...
            \strand [red,thick] (0,0)
                ...
                to (7.5,0)
            ;
            \strand [pux,thick] (7.5,0)
                to [out=0,in=90] (6.67,-\h)
                to [out=-90,in=-90] (11.33,-\h)
                to (11.33,\h)
                to [out=90,in=90] (1.67,\h)
                to [out=-90,in=90] (0.67,0)
                to [out=-90,in=-90,looseness=1.8] (1.33,0)
                to [out=90,in=-90] (2.33,\h)
                to [out=90,in=90] (10.67,\h)
                to (10.67,-\h)
                to [out=-90,in=-90] (7.33,-\h)
                to [out=90,in=-135] (8,{-0.5*\h})
                to [out=45,in=180] (8.5,0)
            ;
            \strand [red,thick] (8.5,0)
                to [out=0,in=-90] (9,0.5)
                to (9,\h)
                ...
                to [out=90,in=90] (6,\h)
                to (6,-\h)
                to [out=-90,in=-90,looseness=0.7] (-1.5,-\h)
                to (-1.5,\h)
                to [out=90,in=90] (1,\h)
                to [out=-90,in=90] (2,0)
                to (2,-\h)
            ...
            \strand [max,thick] (7,0)
                to [out=-90,in=90] (6.33,-\h)
                to [out=-90,in=-90] (11.67,-\h)
                to (11.67,\h)
                to [out=90,in=90] (1.33,\h)
                to [out=-90,in=90] (0.33,0)
                to [out=-90,in=-90,looseness=1.8] (1.67,0)
                to [out=90,in=-90] (2.67,\h)
                to [out=90,in=90] (10.33,\h)
                to (10.33,-\h)
                to [out=-90,in=-90] (7.67,-\h)
                to [out=90,in=90,looseness=2] (8,-\h)
            ;
            \strand [red,thick] (8,-\h)
                to [out=-90,in=-90] (10,-\h)
                to (10,\h)
                to [out=90,in=90] (3,\h)
                to (3,-\h)
                to [out=-90,in=-90] (-0.5,-\h)
                to (-0.5,-0.5)
                to [out=90,in=180] (0,0)
            ;
            \flipcrossings{1,2,3,4,7,8,9,10,12,22,23,24,25,26,27,28,29,35,36,37,38,39}
        \end{knot}
        \node [verti] at (0,0) {};
        \node [horiz] at (9,\h) {};
        \foreach \x in {1,...,8} {
